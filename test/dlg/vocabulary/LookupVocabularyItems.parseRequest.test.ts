...
describe("LookupVocabularyItems.parseRequest", () => {

    it("parses a valid ids array", () => {
        const delegate = new LookupVocabularyItems({} as any, {} as any);
    ...
    it("throws 400 when ids is not an array", () => {
        const delegate = new LookupVocabularyItems({} as any, {} as any);
        assert.throws(() => delegate.parseRequest(makeReq({ ids: "ID-1" })), /ids/i);
    });
